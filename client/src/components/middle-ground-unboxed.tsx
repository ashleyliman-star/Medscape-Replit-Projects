  ...
  return (
    <section className="mb-12">
      <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center flex items-center justify-center">
        <Scale className="h-14 w-14 md:h-6 md:w-6 md:mr-1" style={{ color: '#064AA7' }} />
        <span className="transform -translate-x-8 md:translate-x-0">Middle Ground and Evolving Perspectives</span>
      </h2>

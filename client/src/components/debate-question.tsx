  ...
  return (
    <section className="text-center mb-8">
      ...
      <div className="max-w-4xl mx-auto mb-6">
        <div className="bg-white rounded-lg border-t-4 border-gray-500 shadow-sm p-6 text-left">
          <div className="flex items-center justify-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-600">Debate Question</h3>
          </div>

...
export default function GroupedArguments({ yesArguments, noArguments, yesPhysician, noPhysician }: GroupedArgumentsProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Physician Headers with Connected Arguments */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        {/* YES Side */}
        <div className="space-y-0">
          <Card className="bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 text-white p-6 rounded-b-none">
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 p-6 rounded-t-none border-t-0">
        ...
        {/* NO Side */}
        <div className="space-y-0">
          <Card className="bg-gradient-to-br from-purple-600 via-violet-500 to-indigo-600 text-white p-6 rounded-b-none">
            <div className="flex items-center mb-4">
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 p-6 rounded-t-none border-t-0">
              ...
              {noArguments.map((argument, index) => (
                <div key={index}>
                  ...
                  <ul className="space-y-2">
                    {argument.points.map((point, pointIndex) => (
                      <li key={pointIndex} className="flex items-start">
                        <div className="w-2 h-2 rounded-full bg-purple-600 mt-2 mr-3 flex-shrink-0" />
                        <span className="text-sm text-gray-700 leading-relaxed">{point}</span>
                      </li>
                    ))}
                  </ul>

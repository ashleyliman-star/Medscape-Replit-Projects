  ...
  return (
    <div className="space-y-8">
      ...
      <div className="md:hidden mb-6">
        <h3 className="text-lg font-bold text-gray-800 mb-3">Key Arguments</h3>
        {Array.from({ length: Math.max(yesArguments.length, noArguments.length) }).map((_, index) => (
          <div key={index}>
            <div className="space-y-4 mb-4">
              ...
              {yesArguments[index] && (
                <div className="mb-4">
                  <div className="flex items-start mb-2 gap-2">
                    <span className="text-white px-3 py-1 rounded-full font-semibold text-sm mt-0.5" style={{ backgroundColor: '#3DC7F5' }}>
                      Yes
                    </span>
                  ...
                  <div className="ml-6">
                    {yesArguments[index].points.map((point, pointIndex) => (
                      <p key={pointIndex} className="text-sm text-gray-700 leading-relaxed">{point}</p>
                    ))}
                  </div>
                </div>
              )}
              ...
              {noArguments[index] && (
                <div className="mb-4">
                  <div className="flex items-start mb-2 gap-2">
                    <span className="text-white px-3 py-1 rounded-full font-semibold text-sm mt-0.5" style={{ backgroundColor: '#F07584' }}>
                      No
                    </span>
